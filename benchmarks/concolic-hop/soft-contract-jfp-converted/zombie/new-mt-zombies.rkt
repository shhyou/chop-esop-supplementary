...
;; this file generated by convert-soft-contract.rkt using new-mt-zombies.sch as input
...
(define (counterexample)
  ...
  (vector
   (concretize-input new-mt-zombies witness)
   '('dead
     'dist
     'draw-on
     'draw-on/color
...
(provide counterexample (rename-out (new-mt-zombies test-property)))
