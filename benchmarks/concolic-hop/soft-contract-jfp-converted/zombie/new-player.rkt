...
;; this file generated by convert-soft-contract.rkt using new-player.sch as input
...
(define (counterexample)
  ...
  (vector
   (concretize-input new-player witness)
   '('dist 'draw-on 'draw-on/image 'move-toward 'move-toward/speed 'posn 'x 'y)
   `#hash((solve-count . ,(concolic-statistics-solve-count stats))
          (solve-real-nongc-time
           .
           ,(concolic-statistics-solve-real-nongc-time stats))
          (test-count . ,(concolic-statistics-test-count stats)))))
(provide counterexample (rename-out (new-player test-property)))
