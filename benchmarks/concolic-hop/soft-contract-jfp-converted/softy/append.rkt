...
;; this file generated by convert-soft-contract.rkt using append.sch as input
...
(define-concolic-test
 ...
 (prop-not-exn
  (λ ()
    ...
    (define-id-with-ctc
     (-> (listof any/c) (listof any/c) cons?)
     _append
     append
     bug
     bug)
...
(define (counterexample)
  (define test-result (concolic-test append #:all? #f #:statistics? #t))
  (define witness (list-ref test-result 0))
  (define stats (list-ref test-result 1))
  (vector
   (concretize-input append witness)
   '()
...
(provide counterexample (rename-out (append test-property)))
