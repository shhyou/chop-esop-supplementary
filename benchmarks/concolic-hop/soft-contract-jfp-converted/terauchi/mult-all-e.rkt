...
;; this file generated by convert-soft-contract.rkt using mult-all-e.sch as input
...
(define-concolic-test
 ...
 (prop-not-exn
  (λ ()
    ...
    (define (_h y) (assert (<= (+ y y) (_mult y y))))
    (define (_main n) (_h n))
...
(define (counterexample)
  (define test-result (concolic-test mult-all-e #:all? #f #:statistics? #t))
  (define witness (list-ref test-result 0))
  (define stats (list-ref test-result 1))
  (vector
   (concretize-input mult-all-e witness)
   '()
...
(provide counterexample (rename-out (mult-all-e test-property)))
