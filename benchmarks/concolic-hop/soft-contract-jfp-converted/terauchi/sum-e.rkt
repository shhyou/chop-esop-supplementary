...
;; this file generated by convert-soft-contract.rkt using sum-e.sch as input
...
(define-concolic-test
 ...
 (prop-not-exn
  (λ ()
    ...
    (define (_main n) (assert (<= 100 (_sum n))))
...
(define (counterexample)
  (define test-result (concolic-test sum-e #:all? #f #:statistics? #t))
  (define witness (list-ref test-result 0))
  (define stats (list-ref test-result 1))
  (vector
   (concretize-input sum-e witness)
   '()
...
(provide counterexample (rename-out (sum-e test-property)))
