...
;; this file generated by convert-soft-contract.rkt using ex-02.sch as input
...
(define (counterexample)
  (define test-result (concolic-test ex-02 #:all? #f #:statistics? #t))
  (define witness (list-ref test-result 0))
  (define stats (list-ref test-result 1))
  (vector
   (concretize-input ex-02 witness)
   '()
...
(provide counterexample (rename-out (ex-02 test-property)))
