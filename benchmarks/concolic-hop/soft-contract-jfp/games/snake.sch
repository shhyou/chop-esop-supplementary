...
(module data racket
  (provide (contract-out
   ...
   [struct snake ([dir DIR/C] [segs (non-empty-listof POSN/C)])]
  ...
  (define SNAKE/C (struct/c snake DIR/C (non-empty-listof POSN/C)))
...
(module cut-tail racket
  (provide/contract
   [cut-tail ((non-empty-listof POSN/C) . -> . (listof POSN/C))])
  (require (submod ".." data))
  ;; NeSegs is one of:
  ;; - (cons Posn empty)
  ;; - (cons Posn NeSegs)
